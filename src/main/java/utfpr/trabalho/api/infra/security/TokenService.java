...
public class TokenService {
    ...
    public String validateToken(String token){
        ...
        try{
            ...
            System.out.println(" decoded jwt get id "+decodedJWT.getId());
            System.out.println(" decoded jwt get signature "+decodedJWT.getSignature());
            System.out.println(" decoded jwt get class to string "+decodedJWT.getClass().toString());
