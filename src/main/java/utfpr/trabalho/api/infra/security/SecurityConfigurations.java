    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/tracking").authenticated()
                        .requestMatchers(HttpMethod.POST, "/tracking/save").authenticated()
                        .requestMatchers(HttpMethod.GET, "/tracking/getAllTrackings").authenticated()
